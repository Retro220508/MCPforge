          ...
          <div className="mt-12 grid grid-cols-1 gap-8 lg:grid-cols-3">
            {HOW_IT_WORKS.map(({ step, icon: Icon, title, description, example }) => (
              <div key={step} className="relative">
                {/* Connector line */}
                <div className="hidden lg:block absolute top-6 left-[calc(100%_-_0px)] w-full h-px bg-gradient-to-r from-violet-200 to-transparent" style={{ width: 'calc(100% - 24px)', left: '100%' }} />
        ...
        <div className="mx-auto max-w-6xl">
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            ...
            <div className="flex items-center gap-6 text-sm text-slate-500">
              ...
              <button onClick={() => onNavigate('blog')} className="hover:text-slate-900">Blog</button>
